  ...
  return (
    <div className="w-full mx-auto p-4 space-y-6">
      <div className='space-y-2'>
        <h1 className="text-4xl font-bold">Products Details</h1>
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
            ...
            <div className="w-2/3 pl-4">
              ...
              <div className="flex items-center mt-2">
                <span className="text-yellow-500 flex items-center">
                  <StarIcon className="w-4 h-4" /> {product.rate} ({product.review_count}+ ratings)
                </span>
                <span className="ml-4 text-gray-500">Sold {product.sold}+</span>
                <span className="ml-4 text-blue-500 cursor-pointer">Discuss</span>
              </div>
              <p className="text-xl font-bold mt-4">RP. {product.price.toFixed(2)}</p>
              <div className="mt-4">
          ...
          <Card className="shadow-lg">
            ...
            <CardContent>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold">Adama Lalana</h4>
      ...
      <Card className="shadow-lg mt-6">
        ...
        <CardContent>
          <div className="flex items-start space-x-4 mb-4">
            <div className="w-10 h-10 bg-gray-300 rounded-full"></div>
            <div>
              <p className="font-semibold">Zitta Cantik</p>
              <p className="text-sm text-gray-500">40 menit lalu</p>
              <p className="mt-2">Kak apakah bisa tukar product?</p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            <div className="w-10 h-10 bg-gray-300 rounded-full"></div>
            <div>
              <p className="font-semibold">Admin DBIX</p>
              <p className="text-sm text-gray-500">40 menit lalu</p>
              <p className="mt-2">Dengan senang hati</p>
            </div>
          </div>
        </CardContent>
      </Card>
